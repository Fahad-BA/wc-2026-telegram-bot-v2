...
API_KEY = os.getenv("API_FOOTBALL_KEY", "d74ed4898dd30d9f491f2e33e6a6abbe")
    ...
    async def handle_date_selection(callback: CallbackQuery):
        ...
        async with aiohttp.ClientSession() as session:
            ...
            if data and data.get('response') and len(data['response']) > 0:
                ...
                # 3. If all matches are finished, upgrade to "infinite" in cache
                if all_finished:
